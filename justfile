...
test:
    dart test packages/intentcall_schema packages/intentcall_core packages/intentcall_session packages/intentcall_mcp packages/intentcall_webmcp packages/intentcall_gemma packages/acp_toolkit packages/intentcall_platform_sync packages/intentcall_hooks packages/intentcall_bridge packages/intentcall_codegen/test packages/intentcall_cli packages/intentcall_platform packages/intentcall_platform_apple packages/intentcall_platform_android packages/intentcall_testing tool/intentcall
...
# Canonical script lives in mcp_flutter (dogfood consumer). Requires sibling
# mcp_flutter, Flutter, and Xcode — skips gracefully when absent.
apple-runner-compile-check:
    bash ../mcp_flutter/tool/contracts/check_apple_runner_compile.sh
