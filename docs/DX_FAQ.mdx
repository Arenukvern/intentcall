...
`intentcall_core-v0.2.1`. Each tag triggers `.github/workflows/pub_publish.yml`,
...
# equivalent to: dart run tool/intentcall/bin/intentcall.dart publish-tag --tag intentcall_session-v0.2.1 --skip-existing
```
