...
|---|---|---|
| `inlineRuntime` | Dart-first WebMCP can execute in the current page runtime when bound. | Apple native inline execution and app-extension-hosted Dart are not supported. |
