...
|---|---|---|
| `inlineRuntime` | Current where IntentCall has an exposed runtime already bound and authorized, presently Dart-first WebMCP. | Apple native inline execution, app-extension-hosted Dart, and background Flutter/Dart runtime startup are not supported. |
